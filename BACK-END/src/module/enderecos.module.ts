...
import { Endereco } from '../db/entities';
...
export class EnderecosService {
  ...
  create(data: Partial<Endereco>) {
    return this.repository.save(this.repository.create(data));
  }

  async update(id: string, data: Partial<Endereco>) {
...
export class EnderecosController {
  ...
  @Post()
  create(@Body() body: Partial<Endereco>) {
    return this.service.create(body);
  }

  @Put(':id')
  update(@Param('id') id: string, @Body() body: Partial<Endereco>) {
